  ...
  return (
    <div className='body-container' id='body-cont'>
       <div className='top-section'>
            ...
            <div className='top-img-cont'><img src='https://i.postimg.cc/Y23Mmccy/scam.png'></img></div>
       </div>
       <div className='lower-section'>
            ...
            <div className='lower-img-cont'><img src='https://i.postimg.cc/T3Z6Xfmh/steamscam.png'></img></div>
       </div>
    </div>
  );
}
