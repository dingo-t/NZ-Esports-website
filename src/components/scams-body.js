  ...
  return (
    <div className='body-container' id='body-cont'>
       <div className='top-section'>
            ...
            <div className='top-img-cont'><img alt='screenshot of a discord scam' loading='lazy' src='../images/DiscordScam.png'></img></div>
       </div>
       <div className='lower-section'>
            ...
            <div className='lower-img-cont'><img alt='screenshot of a steam scam' loading='lazy' src='../images/SteamScam.png'></img></div>
       </div>
    </div>
  );
}
